...
window.CamtourI18n = (() => {
  ...
  const DICT = {
    ...
    plan_partial_ready: { fr: "✨ Votre voyage arrive, jour après jour…", en: "✨ Your trip is arriving, day by day…" },
    plan_day_label: { fr: "Jour", en: "Day" },
    plan_day_pending: { fr: "CAMTOUR AI prépare le jour {n}…", en: "CAMTOUR AI is preparing day {n}…" },
